...
function agency_auth_defaults() {
	return array(
		...
		'email_subject'              => __( 'Fiók megerősítése', 'agency-module-auth' ),
		'email_body'                 => __( '<p>Üdvözlünk! Az email címedet itt tudod megerősíteni: {{verification_url}}</p>', 'agency-module-auth' ),
	);
}
