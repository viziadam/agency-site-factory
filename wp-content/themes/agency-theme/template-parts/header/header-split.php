...
<header class="agency-site-header agency-site-header--split">
	<div class="agency-container agency-site-header__inner">
		...
		<nav class="agency-navigation" aria-label="<?php esc_attr_e( 'Elsődleges navigáció', 'agency-theme' ); ?>">
		...
		?>
		<?php if ( $booking_url ) : ?>
			<a class="agency-button agency-button--primary agency-header-cta" href="<?php echo esc_url( $booking_url ); ?>"><?php esc_html_e( 'Időpontfoglalás', 'agency-theme' ); ?></a>
		<?php endif; ?>
	</div>
</header>
