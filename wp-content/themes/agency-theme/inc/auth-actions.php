...
function agency_theme_render_auth_actions() {
	...
	echo '<div class="agency-header-auth" aria-label="' . esc_attr__( 'Account actions', 'agency-theme' ) . '">';
	...
	if ( is_user_logged_in() ) {
		...
		echo '<a class="agency-header-auth__link" href="' . esc_url( $account_url ) . '">' . esc_html__( 'My account', 'agency-theme' ) . '</a>';
		echo '<a class="agency-header-auth__button agency-header-auth__button--secondary" href="' . esc_url( $logout_url ) . '">' . esc_html__( 'Sign out', 'agency-theme' ) . '</a>';
	} else {
		$login_url    = agency_theme_auth_page_url( 'login', '/bejelentkezes/' );
		$register_url = agency_theme_auth_page_url( 'register', '/regisztracio/' );

		echo '<a class="agency-header-auth__link" href="' . esc_url( $login_url ) . '">' . esc_html__( 'Sign in', 'agency-theme' ) . '</a>';

		if ( ! empty( $settings['registration_enabled'] ) ) {
			echo '<a class="agency-header-auth__button" href="' . esc_url( $register_url ) . '">' . esc_html__( 'Register', 'agency-theme' ) . '</a>';
		}
	}
